...
public class Item {
   ...
   public void insert() throws ClassNotFoundException, SQLException {
      ...
      i.setiPrice(Integer.parseInt(sc.nextLine()));
   ...
   public void iupdate() throws ClassNotFoundException, SQLException {
      ...
      System.out.println("1)분류코드 2)상품코드 3)상품명 4)규격 5)단위 6)업체명 7)창고명 8)단가");
   ...
   public void View() throws ClassNotFoundException, SQLException {
      ...
      System.out.println("분류코드\t상품코드\t상품명\t규격\t단위\t업체명\t창고명\t단가");
      while (rs.next()) {
